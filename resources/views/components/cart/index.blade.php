        ...
        <div class="col-lg-8 mb-4 mb-lg-0">
            ...
            <table class="table">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    @csrf
                    {{method_field('DELETE')}}
                    <input name="productoId" value="{{$producto['producto']->id}}" type="hidden">
          ...
          <div class="bg-light px-4 py-3">
            <div class="row align-items-center text-center">
              <div class="col-md-6 mb-3 mb-md-0 text-md-left"><a class="btn btn-link p-0 text-dark btn-sm" href="{{route('producto.index')}}"><i class="fas fa-long-arrow-alt-left mr-2"> </i>Continue shopping</a></div>
